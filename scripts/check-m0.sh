...
[[ -f "$ROOT/docs/compatibility-modes.md" ]] || fail "compatibility matrix missing"
...
grep -Eq 'structural-only' "$ROOT/docs/compatibility-modes.md" || fail "structural-only mode missing"
grep -Eq 'full' "$ROOT/docs/compatibility-modes.md" || fail "full mode missing"
grep -Eq 'nightly' "$ROOT/docs/compatibility-modes.md" || fail "nightly mode missing"
